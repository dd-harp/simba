...
-   [**`ramp.forcing`**](ramp.forcing.html) is a code library for **`ramp.xds`** with algorithms to implement various models of vector control and health-based malaria interventions
