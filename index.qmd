...
This website was developed to support nimble model building and computation for malaria and other mosquito-transmitted pathogens using a suite R packages available from github. The software was designed for **Sim**ulation-**B**ased **A**nalytics (**SimBA**) and research for malaria and other mosquito-borne pathogens. This website is focused on the software and model building. A companion website was developed to introduce 
[**Malaria Theory**](https://faculty.washington.edu/smitdave/theory/_site/index.html) 
For more information about malaria analytics -- using models for policy support -- please see the companion website,
